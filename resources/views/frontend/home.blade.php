            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">Online Textile Parts Seeling System</h4>
                        <h1 class="mb-5 display-3 text-primary">Original Parts</h1>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="https://miro.medium.com/v2/resize:fit:700/1*5JXKJngpWP-ab4TCYvceUg.jpeg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Ring Item</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="https://c0.wallpaperflare.com/preview/282/566/559/machine-industry-factory-equipment.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Spinning Item</a>
                                </div>
                            </div>
                ...
                <div class="tab-class text-center">
                    <div class="row g-4">
                        <div class="col-lg-4 text-start">
                            <h1>Our Orginal Parts</h1>
                        </div>
                        <div class="col-lg-8 text-end">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-1">
                                        <span class="text-dark" style="width: 130px;">All Category</span>
                                    </a>
                                </li>
                                @foreach ($categories as $cat)
                                <li class="nav-item">
                               
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="{{route('parts.under.category',$cat->id)}}">
