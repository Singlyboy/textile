 ...
 <div class="container-fluid fixed-top ">
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">Pirozali, Gazipur</a></small>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">Textile Parts</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{route('frontend.parts')}}" class="nav-item nav-link">All Parts</a>
              ...
              @guest('customerGuard')            
               <!-- Login Button -->
               <li>
               <a class="" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a>

               </li>
               <!-- Register Button -->
                <li>
                <a class="" data-bs-toggle="modal" data-bs-target="#registationModal">Register</a> 
                </li>   
                @endguest
                @auth('customerGuard')
            <li> 
              <!-- Button trigger modal -->
              <a href="{{route('view.profile')}}" class="" >{{ auth('customerGuard')->user()->name }}
              </a>
             </li>
